...
```bash
python3 .agents/skills/internet-skill-finder/scripts/fetch_skills.py --search "keyword"
```
...
```bash
python3 .agents/skills/internet-skill-finder/scripts/fetch_skills.py --deep-dive REPO SKILL
```
