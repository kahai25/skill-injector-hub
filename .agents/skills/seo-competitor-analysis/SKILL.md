...
```bash
python .agents/skills/seo-competitor-analysis/scripts/generate_seo_charts.py \
...
```bash
python .agents/skills/seo-competitor-analysis/scripts/validate_report_assets.py \
