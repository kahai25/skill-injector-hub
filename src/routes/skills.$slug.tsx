  ...
  head: ({ loaderData }) => {
    ...
    return {
      meta: [
        ...
        { property: "og:url", content: `https://skill-injector-hub.lovable.app/skills/${skill.slug}` },
      ...
      links: [{ rel: "canonical", href: `https://skill-injector-hub.lovable.app/skills/${skill.slug}` }],
    };
  },
