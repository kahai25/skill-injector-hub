...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Skill Injector Hub — open catalog of AI agent skills" },
      {
        name: "description",
        content:
          "Browse open-source AI agent skills and inject them into your own project with one pasted prompt. Free, no login, full credit to the authors.",
      },
      { property: "og:title", content: "Skill Injector Hub" },
      {
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <div className="scanlines flex min-h-screen flex-col bg-background">
        <SiteHeader />
